...
bgmSound.src = "./sounds/bgm.mp4";
const scoreSound = new Audio(); // 점수 획득 소리
scoreSound.src = "./sounds/coin.wav";
const defeatSound = new Audio(); // 게임 오버 소리
defeatSound.src = "./sounds/defeat3.wav";
...
rtanAImage.src = "./images/mario_stand.png";
// (6) 달리는 이미지
const rtanBImage = new Image();
rtanBImage.src = "./images/mario_jump.png";
// (7) 게임 오버 
const rtanCrashImage = new Image();
rtanCrashImage.src = "./images/mario_defeat.png";
// (8) 장애물
const obstacleImage = new Image();
obstacleImage.src = "./images/obstacle3.png";

/** 1-1 그리기 */
const RTAN_WIDTH = 100; // 가로 너비
const RTAN_HEIGHT = 100; // 세로 높이
const RTAN_X = 10; //  초기 X 좌표
const RTAN_Y = 400; //  초기 Y 좌표
...
const OBSTACLE_FREQUENCY = 80; // 장애물 생성 빈도
...
class Obstacle {
    constructor() {
        this.x = canvas.width;
        this.y =
            Math.floor(Math.random() * (canvas.height - OBSTACLE_HEIGHT - 30)) +
            30; // 장애물이 canvas의 상단과 하단에서 30px 이내에 생성되지 않도록 조정
